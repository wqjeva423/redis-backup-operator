...
import (
	...
	"RedisBackupOperator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1d00c65a.bobfintech.com",
	})
	if err != nil {
	...
	if err = (&controllers.RedisoperateReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Redisoperate")
		os.Exit(1)
	}
